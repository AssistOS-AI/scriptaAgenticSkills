...
ref: input-state:culmination-9 -> On launch night, Leora inserts the once-abandoned dedication page back into the finished edition.
ref: output-state:culmination-9 -> their bond shifts from guarded usefulness to acknowledged reciprocity
