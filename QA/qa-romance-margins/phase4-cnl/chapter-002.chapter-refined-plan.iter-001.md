...
ref: purpose:escalation -> Escalation movement anchored by the misprinted folio night
ref: input-state:escalation-1 -> Talia admits she left after receiving an offer that promised security she never trusted herself to ask Leora for.
ref: output-state:escalation-1 -> repair becomes emotionally riskier than failure
ref: conflict:escalation -> Leora wants the apology named clearly, not tucked inside production chatter, while Talia fears direct honesty will cost them the commission.
ref: chapter-question:escalation-1 -> fatigue makes every careful sentence sound either too sharp or too intimate
ref: answer-shift:romance-relational-escalation-1 -> the studio survives only if the people inside it stop pretending usefulness is neutral
ref: world-pressure:escalation-1 -> Leora wants the apology named clearly, not tucked inside production chatter, while Talia fears direct honesty will cost them the commission.
