...
- {{location:secondary-001}}: the riverside paper warehouse leased for the launch
- {{sensory-anchor:location-secondary}}: cold rope, pallet wood, citrus cleaner, damp cardboard
- {{social-signal:location-secondary}}: public ambition feels possible here only if the private partnership holds together
- {{symbolic-charge:location-secondary}}: a future-facing space that keeps demanding an honest version of the past
- {{conflict-use:location-secondary}}: the launch site turns private hesitation into visible consequence
