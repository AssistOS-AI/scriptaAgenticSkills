...
ref: input-state:investigation-7 -> A batch of folios misprints during an overnight press run, forcing them into the same exhausted shift.
ref: output-state:investigation-7 -> the work begins storing their conflict instead of hiding it
