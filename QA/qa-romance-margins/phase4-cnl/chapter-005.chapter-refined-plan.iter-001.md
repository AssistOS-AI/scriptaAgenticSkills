...
ref: input-state:culmination-4 -> On launch night, Leora inserts the once-abandoned dedication page back into the finished edition.
ref: output-state:culmination-4 -> their bond shifts from guarded usefulness to acknowledged reciprocity
