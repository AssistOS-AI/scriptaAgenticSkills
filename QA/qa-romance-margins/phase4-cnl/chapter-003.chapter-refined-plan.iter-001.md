...
input-state: the misprint mirrors the exact margin shift from the night Talia left
output-state: They salvage the run together, but the repaired sheets now carry a faint doubled margin they decide to keep.
...
chapter-question: the studio forces the past into the present workload
...
world-pressure: the misprint mirrors the exact margin shift from the night Talia left
...
ref: input-state:investigation-2 -> the misprint mirrors the exact margin shift from the night Talia left
ref: output-state:investigation-2 -> They salvage the run together, but the repaired sheets now carry a faint doubled margin they decide to keep.
...
ref: chapter-question:investigation-2 -> the studio forces the past into the present workload
ref: answer-shift:romance-relational-investigation-2 -> the studio survives only if the people inside it stop pretending usefulness is neutral
ref: world-pressure:investigation-2 -> the misprint mirrors the exact margin shift from the night Talia left
