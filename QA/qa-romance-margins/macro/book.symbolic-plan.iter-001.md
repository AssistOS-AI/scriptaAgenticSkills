...
pitch-test: {{character:protagonist-001}} must decide whether to protect professional distance or accept the vulnerability required for partnership
...
thematic-statement: intimacy does not erase autonomy, but it does demand honest interdependence
pole-a: is
