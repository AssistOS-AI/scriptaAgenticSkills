...
input-state: {{input-state:escalation-7}}
output-state: {{output-state:escalation-7}}
...
chapter-question: {{chapter-question:escalation-7}}
answer-shift: {{answer-shift:romance-relational-escalation-7}}
arc-stage: pressure-rise
world-pressure: {{world-pressure:escalation-7}}
