...
hook: Homicide Inspectors who pursue prove that a staged drowning was a political murder risk justice, public trust, and her younger brother's safety
protagonist: Darius Vale
...
story-question: how much of the city must she accuse in order to save one dead woman from silence?
audience-fit: detective / police readers
pitch-test: Darius Vale must decide whether to close the case cleanly or expose the system that employs her
...
@theme define
topic: power-corruption
moral-shape: resistance
thematic-question: can lawful institutions still deliver justice when they profit from concealment?
thematic-statement: institutions that value stability over truth become complicit in violence
pole-a: can
pole-b: protective-concealment
moral-pressure: close the case cleanly or expose the system that employs her
transformation-vector: move Darius Vale from defensive certainty toward costly honesty
...
macro-form: linear
beginning: establish Darius Vale inside the civic tribunal annex and the pressure around city hall
inciting-incident: an inspector reopens a drowning case after evidence suggests the victim died while uncovering municipal corruption
middle: investigation, pressure, and relational strain expose the cost of prove that a staged drowning was a political murder
plot-point-1: Darius Vale commits to action instead of withdrawal
midpoint: a sealed witness transcript reveals a hidden layer of the conflict
plot-point-2: Matteo Voss turns institutional or personal pressure into direct threat
climax: close the case cleanly or expose the system that employs her
resolution: a new equilibrium forms after Darius Vale accepts irreversible cost
...
transformation-logic: Darius Vale changes while the surrounding system reveals its hidden logic
...
@blueprint map
premise: an inspector reopens a drowning case after evidence suggests the victim died while uncovering municipal corruption
exposition: introduce Darius Vale, the civic tribunal annex, and the first unstable sign around a sealed witness transcript
rising-action: pressure from Matteo Voss and city hall complicates every attempt to act
midpoint-shift: a sealed witness transcript changes what the protagonist understands about the conflict
climax: close the case cleanly or expose the system that employs her
resolution: the core conflict resolves with lasting cost and a redefined relation to city hall
