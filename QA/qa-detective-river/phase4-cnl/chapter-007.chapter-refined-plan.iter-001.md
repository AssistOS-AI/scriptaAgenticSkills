...
ref: input-state:culmination-6 -> During the precinct briefing, Nadia projects the recovered footage before Soren can suspend her.
ref: output-state:culmination-6 -> the case survives because the institution loses control of its own narrative
