...
input-state: a duplicate maintenance form appears with two different timestamps
output-state: They identify a stolen drive case tagged as scrap and follow it toward the abandoned control room.
