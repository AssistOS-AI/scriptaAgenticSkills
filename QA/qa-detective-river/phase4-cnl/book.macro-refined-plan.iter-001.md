...
opposition: Soren Arden, precinct chief tied to the riverfront redevelopment board, backed by County Precinct South
...
transformation-vector: move $character-protagonist-001 from if she follows procedure closely enough, the truth will eventually surface toward evidence survives only when someone refuses the procedure designed to neutralize it
...
@central-idea refine
ref: hook:what-if -> Inspector Nadia Voss reopens a river drowning that the county police marked accidental, only to find tide logs, surveillance gaps, and witness transfers pointing back to a redevelopment contract. Diver-journalist Theo Mercer helps her track the physical evidence while precinct chief Soren Arden turns procedure into a moving wall designed to exhaust the case.
ref: desire:protagonist -> prove that the drowning victim was killed before he entered the river lock
ref: opposition:primary -> Soren Arden, precinct chief tied to the riverfront redevelopment board, backed by County Precinct South
...
ref: story-question:central -> Can Nadia prove murder before procedure itself is used to wash the evidence clean?
ref: pitch:what-if -> Nadia Voss must prove that the drowning victim was killed before he entered the river lock while Obey the chain of command and lose the victim forever, or break protocol and prove the station protected the killing.
