...
ref: input-state:escalation-7 -> In the evidence hangar, Nadia and Theo trace the victim's last route through broken camera timestamps.
ref: output-state:escalation-7 -> administrative negligence hardens into coordinated concealment
