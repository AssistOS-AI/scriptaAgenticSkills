...
purpose: Revelation movement anchored by diversion beneath the spillway
input-state: Diversion beneath the spillway
output-state: Nadia must decide whether to log the evidence through Soren's system or leak it to the prosecutor first.
...
chapter-question: the recovered drive contains muted footage of the victim arriving with the deputy mayor alive
...
world-pressure: Theo realizes the victim was killed during a meeting about the lock privatization signatures.
...
ref: purpose:revelation -> Revelation movement anchored by diversion beneath the spillway
ref: input-state:revelation-4 -> Diversion beneath the spillway
ref: output-state:revelation-4 -> Nadia must decide whether to log the evidence through Soren's system or leak it to the prosecutor first.
ref: conflict:revelation -> Nadia must decide whether to log the evidence through Soren's system or leak it to the prosecutor first.
ref: chapter-question:revelation-4 -> the recovered drive contains muted footage of the victim arriving with the deputy mayor alive
ref: answer-shift:detective-police-revelation-4 -> the cover-up is not separate from the institution; it is how the institution currently functions
ref: world-pressure:revelation-4 -> Theo realizes the victim was killed during a meeting about the lock privatization signatures.
