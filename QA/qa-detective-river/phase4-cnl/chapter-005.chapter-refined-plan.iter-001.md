...
ref: input-state:revelation-4 -> At the abandoned control room, they recover the drive case and a blood-marked retaining bolt.
ref: output-state:revelation-4 -> the investigation turns from hidden search into institutional showdown
