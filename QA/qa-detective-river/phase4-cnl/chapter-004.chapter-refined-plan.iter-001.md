...
input-state: During the precinct briefing, Daria projects the recovered footage before Pavel can suspend her.
...
ref: input-state:culmination-3 -> During the precinct briefing, Daria projects the recovered footage before Pavel can suspend her.
ref: output-state:culmination-3 -> the case survives because the institution loses control of its own narrative
ref: conflict:culmination -> Daria can still frame the scandal as a deputy's mistake or name Pavel as the architect of the concealment.
ref: chapter-question:culmination -> Can Daria prove murder before procedure itself is used to wash the evidence clean?
