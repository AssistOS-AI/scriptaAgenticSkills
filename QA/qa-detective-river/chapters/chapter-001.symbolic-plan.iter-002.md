@chapter-001 define
chapter-role: setup
purpose: establish the detective / police premise and its first instability
input-state: the initial promise is unstable but not yet public
output-state: chapter 1 ends with increased pressure and narrower choices
conflict: the detective / police world resists the first truthful reading of the problem
