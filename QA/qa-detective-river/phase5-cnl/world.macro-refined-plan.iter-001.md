...
holders: Civic Board, Cassia Kepler
activation: the protagonist decodes a falsified autopsy report near the midpoint
...
rule: evidence handling is never neutral inside a system built to absorb accusation
...
rule: publicly useful evidence is always easier to bury than privately damaging rumor
conflict-transform: turns evidence handling into a direct conflict over power
...
rule-to-conflict: bureaucratic scarcity turns evidence into a struggle over institutional access

@location-primary define
name: the flooded riverside promenade
...
name: the civic tribunal annex
role: revelation or narrowing stage
sensory-anchor: old paper, rust, and filtered neon
social-signal: the place teaches everyone to speak as if being recorded
symbolic-charge: a stage where procedural order masks corruption
conflict-use: the location should restrict access and raise suspicion
