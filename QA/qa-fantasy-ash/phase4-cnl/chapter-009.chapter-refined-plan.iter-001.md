...
ref: input-state:culmination-8 -> During the valley rite, Neris interrupts Maeron's succession oath with the stolen seal and the hidden chronicle.
ref: output-state:culmination-8 -> power changes from inherited command to shared burden
