...
- {{location:secondary-001}}: the vow furnace catacombs
- {{sensory-anchor:location-secondary}}: ember breath, iron prayer chains, old ash turning slick under candle wax
- {{social-signal:location-secondary}}: power here speaks in liturgy because law and sacrifice were forged together
- {{symbolic-charge:location-secondary}}: the family's hidden engine where legitimacy is literally burned into permanence
- {{conflict-use:location-secondary}}: secrets become material once spoken beside the furnace that consumed them
