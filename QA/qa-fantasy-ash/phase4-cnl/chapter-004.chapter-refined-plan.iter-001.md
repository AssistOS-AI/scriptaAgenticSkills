...
ref: input-state:revelation-3 -> A winter spirit tests the valley ward while Maeron accuses Neris of inviting the breach through disobedience.
ref: output-state:revelation-3 -> renunciation becomes the only form of leadership left to her
