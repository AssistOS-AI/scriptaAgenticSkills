...
input-state: In the catacombs, Caelan reveals furnace records listing each life traded into the mountain wards.
output-state: the oath becomes both a crime and a necessary shield
...
ref: purpose:investigation -> Escalation movement anchored by chronicle beneath the chains
ref: conflict:investigation -> Neris wants to expose Maeron immediately, yet doing so before the warding rite could leave the valley open to the winter breach.
ref: chapter-question:investigation -> Can Neris free the valley from her family's vow without leaving it defenseless against the cost the vow once contained?
ref: world-pressure:investigation -> every promise of protection arrives already entangled with control, debt, and ancestral shame
ref: input-state:investigation-7 -> In the catacombs, Caelan reveals furnace records listing each life traded into the mountain wards.
ref: output-state:investigation-7 -> the oath becomes both a crime and a necessary shield
