...
purpose: {{purpose:reversal}}
input-state: {{input-state:reversal-5}}
output-state: {{output-state:reversal-5}}
conflict: {{conflict:reversal}}
...
answer-shift: {{answer-shift:science-fiction-reversal-5}}
