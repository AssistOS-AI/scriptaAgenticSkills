...
input-state: {{input-state:setup-0}}
output-state: {{output-state:setup-0}}
conflict: {{conflict:setup}}
...
chapter-question: {{chapter-question:setup-0}}
answer-shift: {{answer-shift:science-fiction-setup-0}}
arc-stage: entry-instability
world-pressure: {{world-pressure:setup-0}}
