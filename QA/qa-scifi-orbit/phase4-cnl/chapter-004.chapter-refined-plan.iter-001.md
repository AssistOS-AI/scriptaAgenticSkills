...
input-state: A council drone nearly traps them, forcing Elian to copy partial manifests rather than the whole route map.
output-state: the conspiracy reaches into Elian's professional past
...
chapter-question: locate the archive ring without triggering a council lockdown
answer-shift: peace without memory turns citizens into well-maintained evidence gaps
arc-stage: threshold-crossing
world-pressure: the conspiracy reaches into Elian's professional past
...
ref: input-state:bridge-3 -> A council drone nearly traps them, forcing Elian to copy partial manifests rather than the whole route map.
ref: output-state:bridge-3 -> the conspiracy reaches into Elian's professional past
...
ref: chapter-question:bridge-3 -> locate the archive ring without triggering a council lockdown
ref: answer-shift:science-fiction-bridge-3 -> peace without memory turns citizens into well-maintained evidence gaps
ref: world-pressure:bridge-3 -> the conspiracy reaches into Elian's professional past
