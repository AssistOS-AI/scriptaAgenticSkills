...
ref: input-state:culmination-6 -> As the council begins a fresh memory smoothing cycle, Elian hijacks the orchard display lattice.
ref: output-state:culmination-6 -> peace fractures, but consent re-enters the political life of the station
