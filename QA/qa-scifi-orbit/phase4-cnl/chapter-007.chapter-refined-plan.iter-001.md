...
ref: input-state:escalation-6 -> Yara flies Elian through maintenance lanes no civilian archivist is meant to access.
ref: output-state:escalation-6 -> the station reveals a physical pathway for forgetting
