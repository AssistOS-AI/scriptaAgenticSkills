...
- {{location:secondary-001}}: the sealed archive airlock beneath Council Spoke Three
- {{sensory-anchor:location-secondary}}: static-dry metal, cryogenic dust, dormant server fans
- {{social-signal:location-secondary}}: only governance enters here with official reason, which is why truth feels contraband
- {{symbolic-charge:location-secondary}}: the station's missing conscience locked behind procedural sterility
- {{conflict-use:location-secondary}}: once opened, the room turns abstract ethics into recoverable names and files
...
- {{input-state:culmination-3}}: As the council begins a fresh memory smoothing cycle, Elian hijacks the orchard display lattice.
- {{output-state:culmination-3}}: peace fractures, but consent re-enters the political life of the station
