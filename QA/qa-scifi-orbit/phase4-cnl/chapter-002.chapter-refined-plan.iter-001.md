...
@chapter-002 refine
ref: stakes:freedom-consent-memory-agency -> what is at risk if the protagonist fails
ref: answer-shift:science-fiction -> how the answer shifts across this chapter
...
ref: chapter-question:escalation -> Can Elian restore the station's memory without destroying the fragile peace built on forgetting?
ref: world-pressure:escalation -> how world rules create pressure in this unit
