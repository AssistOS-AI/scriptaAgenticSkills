...
input-state: They discover phantom cargo movements feeding a hidden archive airlock after every major policy dispute.
output-state: technical distance gives way to personal implication
...
chapter-question: the shuttle navigation grid reassigns routes whenever forbidden sectors are approached
answer-shift: peace without memory turns citizens into well-maintained evidence gaps
arc-stage: pressure-rise
world-pressure: Elian still hopes the council preserved the memories for lawful quarantine, while Yara assumes the archive is a burial chamber for dissent.
...
ref: purpose:escalation -> Escalation movement anchored by cargo route for the vanished vote
ref: input-state:escalation-1 -> They discover phantom cargo movements feeding a hidden archive airlock after every major policy dispute.
ref: output-state:escalation-1 -> technical distance gives way to personal implication
ref: conflict:escalation -> Elian still hopes the council preserved the memories for lawful quarantine, while Yara assumes the archive is a burial chamber for dissent.
ref: chapter-question:escalation-1 -> the shuttle navigation grid reassigns routes whenever forbidden sectors are approached
ref: answer-shift:science-fiction-escalation-1 -> peace without memory turns citizens into well-maintained evidence gaps
ref: world-pressure:escalation-1 -> Elian still hopes the council preserved the memories for lawful quarantine, while Yara assumes the archive is a burial chamber for dissent.
