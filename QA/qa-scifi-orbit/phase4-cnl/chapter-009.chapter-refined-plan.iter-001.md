...
ref: input-state:culmination-8 -> As the council begins a fresh memory smoothing cycle, Elian hijacks the orchard display lattice.
ref: output-state:culmination-8 -> peace fractures, but consent re-enters the political life of the station
