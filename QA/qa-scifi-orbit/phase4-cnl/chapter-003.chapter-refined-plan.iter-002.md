...
input-state: the recovered vote proves the station once rejected the pacification protocol outright
output-state: Elian prepares a targeted broadcast that returns the erased council vote first, not the entire archive at once.
...
ref: input-state:revelation-2 -> the recovered vote proves the station once rejected the pacification protocol outright
ref: output-state:revelation-2 -> Elian prepares a targeted broadcast that returns the erased council vote first, not the entire archive at once.
