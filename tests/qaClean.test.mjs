...
test('QA clean preserves specs and removes generated QA output', async () => {
  ...
  try {
    ...
    await mkdir(`${qaRoot}/metrics`, { recursive: true });
    ...
    await writeFile(`${qaRoot}/metrics/qa-drama-silence.html`, '<html></html>\n', 'utf8');
    ...
    await assert.rejects(readFile(`${qaRoot}/books/en/qa-drama-silence.html`, 'utf8'));
    await assert.rejects(readFile(`${qaRoot}/metrics/qa-drama-silence.html`, 'utf8'));
